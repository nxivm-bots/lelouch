...
BOT_TOKEN = os.environ.get("BOT_TOKEN", "7240324742:AAGARczMApTFlTJWdoWoIPyEFTt80yH8Yrs")
...
DB_URL = os.environ.get("DB_URL", "/mongo mongodb+srv://kratosnigger:GuH0qHewCzuynCE4@telegram.mhwll.mongodb.net/")
